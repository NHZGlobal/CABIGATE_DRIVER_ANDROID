...
public class CurrentJobAdapter extends RecyclerView.Adapter<CurrentJobAdapter.CustomViewHolder> {
    ...
    public CurrentJobAdapter(Activity context, List<Job> lists) {
        this.lists = lists;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup,final int i) {
        final View view1 = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_queue_open_job, null);

        final CustomViewHolder viewHolder = new CustomViewHolder(view1);
        view1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            onItemClickListener.onQueueItemClick(view1, viewHolder.getAdapterPosition());
            }
        });
        return viewHolder;
    }
